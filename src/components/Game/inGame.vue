            ...
            <div id="ex_doll_game">
                <div class="doll-machine">
                    <div class="machine" id="machine">
                        ...
                        <i class="machine-clip-line" id="machine-clip-line" style="height:700px;"></i>
    ...
    mounted() {
        ...
        function restTransition(domName,type) {
            if(domName == 'xy'){
                ...
                $('.machine-shadow').css('transform', 'translateY(' + n*6 + 'px)');
                $('.machine-shadow').css('-webkit-transform', 'translateY(' + n*6 + 'px)');
