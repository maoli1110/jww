...
function ClampDoll() { /*钩子*/
    ...
    games.isRun = !1,
        ...
        this.rising = function() { /*钩子触碰到*/
            ...
            setTimeout(function() {
                move(_clip).set("transform", b).duration(4e3).ease("linear").end();
        ...
        this.catchDoll = function(a) {
            ...
            //         // (Math.abs(e-b) <= -2) && (a = $(d).attr("data-index"))
            //     }),
            //     games.getDoll.call(this, a);
            // }.bind(this), this.setTime.fallingToRising),b
            return setTimeout(function() {
                var a = -1;
                var level = 0;
                b = this.$clip.offset().left;
                ...
                $('#doll-list'+level+' >li').map(function(c, d) {
                    console.log(d,'eee')
                    var e = Math.abs($(d).offset().left);
                    (Math.abs(e-b) <= 4) && (a = $(d).attr("data-index"))
                }),
                games.getDoll.call(this, a);
